let {mainTraffic,hourlyButton,buttonArray,dailyButton,weeklyButton,monthlyButton} = letCombine();
  ...
  let weeklyTrafficData = {
    ...
    data: {
      datasets: [{
        data: [{x:0,y:0},{x:7,y:500},{x:14,y:1000},{x:17,y:750},{x:24,y:1250},{x:31,y:1750},
               {x:38,y:1250},{x:42,y:1500},{x:49,y:1000},{x:56,y:1500},
               {x:63,y:2000},{x:70,y:1500},{x:77,y:2000}],
        backgroundColor: 'rgba(115, 120, 186, .2)',
        borderColor: 'rgba(115, 120, 186, .5)',
        borderWidth: 1,
        pointBackgroundColor: '#fff',
